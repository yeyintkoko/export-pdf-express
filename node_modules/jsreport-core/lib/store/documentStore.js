...
DocumentStore.prototype.init = function () {
  ...
  if (!this.provider && (!this._options.connectionString || this._options.connectionString.name.toLowerCase() === 'memory')) {
    this.provider = new (require('./memoryStore'))(this.model, this._options)
  }

  if (!this.provider) {
    throw new Error('Unsupported store provider ' + this._options.connectionString.name)
  }
